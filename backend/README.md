...
## Project Structure
    ...
    ├── testapiautostoryboa_86601  # Django project configurations
...
1. Clone this repo and `cd testapiautostoryboa_86601`
...
2. Clone this repo and `cd testapiautostoryboa_86601`
